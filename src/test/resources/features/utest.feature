...
Feature: user registers Utest
  ...
  Scenario: user registration
    ...
    When he fills in the registration form
      ...
      |felipe   |andres felipe|beltran valero|felipebeltranvalero@gustr.com|November  |25      |1990      |spanish   |bogota |111161     |colombia |windows |10      |spanish    |xiaomi       |redmi 2     |android 4              |Choucair1.|
